      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            10.hs,
            AppPlayerBar(audioHandler: audioHandler, author: subtitle, title: title, lincToShare: 'https://skontotev.lv/lv/', itIsStream: isMainData),
                  ...
                  CustomCarouselSlider(
                    ...
                    options: CarouselOptions(
                        ...
                        onPageChanged: (index, reason) {
                          if (_isMainData) {
                            context.read<MainScreenProvider>().setPlaylistOnHomePage(index, false, context);
