...
class AppPlayerBar extends StatefulWidget {
  const AppPlayerBar({super.key,  required this.audioHandler, required this.author, required this.title, required this.lincToShare, required this.itIsStream});
                  ...
                  IconButton(
                    onPressed: () {
                      showModalBottomSheet(
                        context: context,
                        builder: (builder) {
                          return SettingViewByThreeDot(itIsStream: widget.itIsStream, author: widget.author, title: widget.title, lincToShare: widget.lincToShare,);
                        },
                      );
                    },
