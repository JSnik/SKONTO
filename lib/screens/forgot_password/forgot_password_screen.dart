...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  void initState() {
    super.initState();
    Provider.of<AuthProvider>(context, listen: false).forgotPasswordResponseState = ResponseState.stateFirsLoad;
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  RoutedButtonWidget(
                      ...
                      title: Singleton.instance.translate('restore_title'),
                      onTap: () {
                        if (authProvider.forgotPasswordResponseState != ResponseState.stateLoading) {
