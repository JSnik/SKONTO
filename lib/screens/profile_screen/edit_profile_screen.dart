  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider.value(
        ...
        child: Consumer<ProfileProvider>(builder: (context, profileProvider, _) {
          ...
          if (Provider.of<AuthProvider>(context, listen: false).placesOfResidence.apiVersion != '' && profileProvider.editUserProfile.data.city != 0) {
          ...
          if (profileProvider.editUserProfile.data.education == 'basic') {
            ...
            profileProvider.editUserProfile.data.educationAdvanced = false;
          } else if (profileProvider.editUserProfile.data.education == 'higher') {
            profileProvider.editUserProfile.data.educationAdvanced = true;
            profileProvider.editUserProfile.data.educationBasic = false;
            profileProvider.editUserProfile.data.educationIntermediate = false;
          }
          if (profileProvider.editUserProfile.data.personSex == 'male') {
            profileProvider.editUserProfile.data.isMan = true;
            profileProvider.editUserProfile.data.isWoman = false;
          } else if (profileProvider.editUserProfile.data.personSex == 'female') {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    YearSelectorWidget(onSelectYear: (String text) {
                      ...
                      profileProvider.notifyListeners();
                    }, initText: profileProvider.editUserProfile.data.birthYear.toString(), errorText: null,),
                    const SizedBox(height: 30),
                    ...
                    Row(
                      children: [
                        CustomCheckBoxWidget(
                            ...
                            selectedValue: (value) {
                              profileProvider.editUserProfile.data.personSex = 'female';
                              profileProvider.notifyListeners();
                            },
                        ...
                        CustomCheckBoxWidget(
                            ...
                            selectedValue: (value) {
                              profileProvider.editUserProfile.data.personSex = 'male';
                              profileProvider.notifyListeners();
                            },
                    ...
                    AppTextFieldWidget(onChanged: (text) {
                      profileProvider.editUserProfile.data.prizeShippingAddress = text;
                      profileProvider.notifyListeners();
                    }, capitalization: TextCapitalization.words, hintText: '', initialText: profileProvider.editUserProfile.data.prizeShippingAddress,),
                    const SizedBox(height: 25),
                    Text(Singleton.instance.translate('card_number'), style: AppTextStyles.main16regular),
                    AppTextFieldWidget(onChanged: (text) {
                      profileProvider.editUserProfile.data.bankCard = text;
                      profileProvider.notifyListeners();
                    }, capitalization: TextCapitalization.words, hintText: '', initialText: profileProvider.editUserProfile.data.bankCard),
                    const SizedBox(height: 25),
                    Text(Singleton.instance.translate('residence_title'), style: AppTextStyles.main16regular),
                    ResidenceSelectorWidget(onSelect: (int text, String name) {
                    ...
                    Column(mainAxisAlignment: MainAxisAlignment.end,
                      ...
                      children: [
                        SizedBox(height: 45,
                          child: Row(
                            ...
                            children: [
                              ...
                              Expanded(child: AppTextFieldWidget(onChanged: (text) {
                        ...
                        Container(margin: const EdgeInsets.only(right: 25),
