...
class WebViewScreen extends StatefulWidget {
  const WebViewScreen({super.key, required this.url, this.bottomPadding, this.hideBackButton, this.hideAppBar, this.topPadding});
...
class _WebViewScreenState extends State<WebViewScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          widget.topPadding == null ? const SizedBox() : SizedBox(height: widget.topPadding),
