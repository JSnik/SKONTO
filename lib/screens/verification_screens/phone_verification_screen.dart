                ...
                body: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      widget.phone == '' ? const SizedBox() : Text('+${authProvider.registerPhoneCode}${widget.phone}', style: AppTextStyles.main16bold),
                      const SizedBox(height: 20),
                      Row(
                        children: [
                      ...
                      AppTextFieldWidget(
                        ...
                        errorText: validateNotEmptyField(smsCode, firstLoad),
                      ),
