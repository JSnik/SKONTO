      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            }, capitalization: TextCapitalization.words, hintText: Singleton.instance.translate('hint_text'),
              initialText: authProvider.registerName,
              errorText: validateNotEmptyField(authProvider.registerName, !authProvider.registerIsButtonRegisterPress),),
            ...
            AppTextFieldWidget(
              ...
              initialText: authProvider.registerSurname,
              errorText: validateNotEmptyField(authProvider.registerSurname, !authProvider.registerIsButtonRegisterPress),),
            const SizedBox(height: 45),
            ...
            YearSelectorWidget(onSelectYear: (String text) {
              ...
              errorText: validateNotEmptyField(authProvider.registerYearOfBirth, !authProvider.registerIsButtonRegisterPress),),
            const SizedBox(height: 45),
            ...
            AppTextFieldWidget(
              onChanged: (text) {
                authProvider.prizeShippingAddress = text;
              }, capitalization: TextCapitalization.words,
                initialText: authProvider.prizeShippingAddress,
            ...
            ResidenceSelectorWidget(onSelect: (int id, String name) {
              authProvider.currentResidenceId = id;
              authProvider.currentResidence = name;
              authProvider.notifyListeners();
              // profileProvider.editUserProfile.data.city = text;
              // profileProvider.notifyListeners();
            }, initText: authProvider.currentResidence,),
            const SizedBox(height: 45),
            ...
            AppTextFieldWidget(onChanged: (text) {
              ...
              authProvider.notifyListeners();
                ...
                initialText: authProvider.registerEmail,
                errorText: validateNotEmptyField(authProvider.registerEmail, !authProvider.registerIsButtonRegisterPress)),
            const SizedBox(height: 45),
            ...
            AppTextFieldWidget(onChanged: (text) {
              ...
              errorText: validatePasswordField(authProvider.registerPassword, !authProvider.registerIsButtonRegisterPress),
              initialText: authProvider.registerPassword,
              isPassword: true),
            const SizedBox(height: 45),
            ...
            AppTextFieldWidget(onChanged: (text) {
              ...
              authProvider.notifyListeners();
                ...
                errorText: validateRepeatPasswordField(authProvider.registerPassword, authProvider.registerRepeatPassword, !authProvider.registerIsButtonRegisterPress),
            ...
            RoutedButtonWidget(
              ...
              if (authProvider.canPressNextOnRegister(context)) {
