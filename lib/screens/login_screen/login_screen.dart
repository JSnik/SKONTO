              ...
              children: myTabs.mapIndexed((index, tab) {
                ...
                LoginWidget(
                  ...
                  onLogInPress: () {
                    ...
                    authProvider.login(login, password, context);
                    },
                  isLogInButtonLoading: authProvider.loginResponseState == ResponseState.stateLoading ? true : false,
                  errorTextPhone: validateNotEmptyField(login, !isLoginButtonPress),
                  errorTextPassword: validateNotEmptyField(password, !isLoginButtonPress),)
                    :
                  RegisterWidget();
