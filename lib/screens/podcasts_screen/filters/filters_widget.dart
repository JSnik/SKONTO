...
class FiltersWidget extends StatelessWidget {
              ...
              child: Consumer<PodcastsProvider>(builder: (context, podcastsProvider, _) {
                return Column(
                  ...
                  children: [
                    ...
                    podcastsProvider.currentAppBarIndex == 2 ? const SizedBox() :
                    _filterList(podcastsProvider, Singleton.instance.translate('subcategories_title'), 3)
                  ],
                );
              }),
            ),
  ...
  Widget _filterList(PodcastsProvider podcastsProvider, String title, int numOfSection) {
    ...
    numOfSection == 3 && hatSubCategories == false ? const SizedBox() :
      Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(title, style: AppTextStyles.main14bold),
