...
import 'interview_list_cell.dart';
...
class _InterviewDetailScreenSongsState extends State<InterviewDetailScreenSongs> {
  ...
  Widget build(BuildContext context) {
    String fixedText = widget.interview.description
        .replaceAll("&ldquo;", "“")
        .replaceAll("&rdquo;", "”");
    return Scaffold(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                15.hs,
                StyledText(text: fixedText, maxLines: descriptionLineNum,),
                fixedText.length > 223 && descriptionLineNum != null ?
                Column(
                  children: [
                    10.hs,
                    GestureDetector(
