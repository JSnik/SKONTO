...
class AppBarMainScreenWidget extends StatelessWidget {
  const AppBarMainScreenWidget({super.key, required this.onRadioIconTap, required this.mainDataList, required this.appBarIsExpanded, required this.onItemFocus, required this.data, required this.currentSelectedDataIndex, required this.controller, required this.carouselSliderController});
