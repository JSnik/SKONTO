                      ...
                      CustomCarouselSlider(
                        ...
                        options: CarouselOptions(
                            ...
                            onPageChanged: (index, reason) {
                              if (mainScreenProvider.appBarIsExpanded == true) {
                                mainScreenProvider.currentSelectedPlaylistIndex = index;
                                context.read<PlayerProvider>().carouselSliderControllerAppBar
                                    .animateToPage(
                                      index,
                                ...
                                _timer = Timer(const Duration(milliseconds: 1000), () {
                                  context.read<PlayerProvider>().playAllTypeMedia(
                          ...
                          child: Column(
                            children: [
                              AppBarMainScreenWidget(
                                ...
                                currentSelectedDataIndex: mainScreenProvider.currentSelectedPlaylistIndex,
