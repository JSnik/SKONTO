          ...
          children: [
            ...
            ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  if (index == 6) {
                    return OneImageBannerWidget(banners: mainScreenProvider.mainScreenData.banners, padding: 0);
                  }
                  if (index == 7) {
                  ...
                  if (index == 9) {
                    return HorizontalListWidget(type: MainScreenCellType.video, mainData: mainData,
                      onItemTap: (int index) {
                        Provider.of<DetailProvider>(context, listen: false)
                            .getDetailData(context, mainData.videoPodcasts![index].id, 'podcast').then((value) {
                        });
                  ...
                  if (index == 10) {
                    return HorizontalListWidget(type: MainScreenCellType.interview, mainData: mainData,
                      onItemTap: (int index) {
                        ...
                        context.read<DetailProvider>().getDetailData(context, interview.id, 'interview');
