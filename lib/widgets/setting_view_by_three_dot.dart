...
class SettingViewByThreeDot extends StatefulWidget {
  const SettingViewByThreeDot({super.key, required this.itIsStream, required this.author, required this.title, required this.lincToShare});

  final bool itIsStream;
  final String author;
  final String title;
  final String lincToShare;
...
class _SettingViewByThreeDotState extends State<SettingViewByThreeDot> {
        ...
        return Container(
          ...
          child: Column(
            children: [
              ...
              widget.itIsStream ? const SizedBox() : 30.hs,
              widget.itIsStream ? const SizedBox() :
              Row(
                children: [
                  Text(
              ...
              widget.itIsStream ? const SizedBox() :10.hs,
              widget.itIsStream ? const SizedBox() :
              Row(
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  circleIconView(1, 'assets/icons/whatsapp_icon.svg', 16, widget.lincToShare),
                  circleIconView(2, 'assets/icons/facebook_icon.svg', 19, widget.lincToShare),
                  circleIconView(3, 'assets/icons/instagram_icon.svg', 16, widget.lincToShare),
                  circleIconView(4, 'assets/icons/email_icon.svg', 13, widget.lincToShare),
                  circleIconView(5, 'assets/icons/copy_icon.svg', 16, widget.lincToShare),
                ],
              )
            ],
          ),
  ...
  Widget circleIconView(int index, String iconName, double size, String lincToShare) {
    return GestureDetector(
      onTap: () {
