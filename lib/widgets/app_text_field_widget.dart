...
class AppTextFieldWidget extends StatefulWidget {
  const AppTextFieldWidget(
      {this.initialText, this.errorText, this.isPassword, this.hideLine, this.keyboardType, required this.onChanged, required this.hintText, super.key, this.capitalization, this.minLine, this.needLengthLimit,});
...
class _AppTextFieldWidgetState extends State<AppTextFieldWidget> {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      maxLength: widget.needLengthLimit != null ? 8 : null,
      ...
      decoration: InputDecoration(
        ...
        counterText: '',
        errorBorder: widget.needLengthLimit == null ? null : const UnderlineInputBorder(borderSide: BorderSide(color: Colors.transparent),),
        errorStyle: widget.needLengthLimit == null ? null : const TextStyle(height: 0),
